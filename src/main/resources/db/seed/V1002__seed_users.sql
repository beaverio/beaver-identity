...
VALUES
    ('${user1_id}', NOW(), NOW(), '${user1_email}', '${password_hash}', '${user1_name}', true, '${user1_workspace_id}'),
    ('${user2_id}', NOW(), NOW(), '${user2_email}', '${password_hash}', '${user2_name}', true, '${user2_workspace_id}')
